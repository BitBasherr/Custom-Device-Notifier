...
from .config_flow import CustomDeviceNotifierOptionsFlowHandler
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    try:
        ...
        async def handle_evaluate(call) -> None:
...
class _NotifierService(BaseNotificationService):
    """Forward message to first matching target or fallback."""
    ...
    async def async_send_message(self, message: str = "", **kwargs) -> None:
        """Dispatch message to first matching target (or fallback)."""
