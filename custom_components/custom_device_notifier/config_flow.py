...
class CustomDeviceNotifierConfigFlow(
    ...
    def _schema_condition_more(self) -> vol.Schema:
        ...
        return vol.Schema(
            {
                vol.Required("choice", default=_BACK): selector(
    ...
    def _schema_select_condition_to_edit(self) -> vol.Schema:
        ...
        return vol.Schema(
            {
                vol.Required("condition", default=_BACK): selector(
                    {"select": {"options": opts}}
                )
            }
        )
    ...
    def _schema_target_more(self) -> vol.Schema:
        ...
        return vol.Schema(
            {
                vol.Required("next", default=_BACK): selector(
                    {"select": {"options": options}}
                )
            }
        )
    ...
    def _schema_select_target_to_edit(self) -> vol.Schema:
        ...
        return vol.Schema(
            {
                vol.Required("target", default=_BACK): selector(
                    {"select": {"options": opts}}
                )
            }
        )
    ...
    def _schema_order_targets_progressive(self) -> vol.Schema:
        ...
        return vol.Schema(
            {
                vol.Required("target", default=default_val): selector(
                    {"select": {"options": opts}}
                )
            }
        )
    ...
    async def async_step_add_condition_entity(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema(
                {vol.Required("entity"): selector({"select": {"options": opts}})}
            ),
        )
